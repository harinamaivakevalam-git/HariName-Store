    ...
    this.data.orders = [
      {
        ...
        tracking_url: '/order-tracking.html?order=HN-2026-98124',
        notes: 'Delivered safely with blessings.',
        shiprocket_order_id: 'SR-ORD-9812410',
        shiprocket_shipment_id: 'SR-SHP-882194',
        awb_code: '1432890123456',
        courier_name: 'Delhivery Surface',
        shipping_status: 'DELIVERED',
        shipping_status_code: '7',
        shipping_label_url: null,
        shipping_manifest_url: null,
        pickup_status: 'PICKED_UP',
        pickup_scheduled_date: '2026-09-09',
        tracking_history: [
          { date: '2026-09-08 10:30', status: 'ORDER_CREATED', location: 'Vrindavan Hub', activity: 'Order placed & shipment generated' },
          { date: '2026-09-09 14:15', status: 'PICKED_UP', location: 'Vrindavan Hub', activity: 'Package handed over to courier' },
          { date: '2026-09-10 08:45', status: 'IN_TRANSIT', location: 'Mathura Sorting Facility', activity: 'In transit to destination city' },
          { date: '2026-09-11 11:20', status: 'OUT_FOR_DELIVERY', location: 'Delhi Hub', activity: 'Out for delivery with courier agent' },
          { date: '2026-09-12 16:00', status: 'DELIVERED', location: 'Delhi', activity: 'Delivered to devotee customer' }
        ],
        shipping_updated_at: new Date(Date.now() - 10 * 86400000).toISOString(),
        created_at: new Date(Date.now() - 14 * 86400000).toISOString(),
